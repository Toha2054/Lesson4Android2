package com.example.lesson4android2.client;

import com.example.lesson4android2.R;
import com.example.lesson4android2.model.ViewPagerModel;
...
public class ViewPagerClient {
    ...
    public static ArrayList<ViewPagerModel> getPagerlist() {
        pagerlist.add(new ViewPagerModel("Welcome " +
                ...
                "a thing - we take care of it. ", R.drawable.photo1, "Skip"));
        pagerlist.add(new ViewPagerModel("Collaboration" +
                ...
                "with other members.", R.drawable.photo2, "Skip"));
        pagerlist.add(new ViewPagerModel("How to keep up" +
                ...
                "to track how much time you spend studying! ", R.drawable.photo3, "Get started"));
        return pagerlist;
    }
}
